...
#lon
date<-c('2020/03/26','2020/07/04','2020/09/14','2020/09/24','2020/11/05','2020/12/02','2020/12/20')
measure<-c('Lockdown 1','Lockdown<br>eased','Rule-of-six','Restricted<br>biz-hours','Lockdown 2','Tier 2','Tier 4')
